...
.then(resp => {
    for (let repo of resp) {
        ...
        <div class="card__text-container">
          ...
          <div class="card__smaller-container">
            <p class="card__category">demo:</p> <p class="card__content card__content--demo">&lt;<a class="card__link" href="https://dorotapindur.github.io/${name}/" rel="noopener" target=_blank title="${name} - demo">link to demo</a>&gt;</p>
